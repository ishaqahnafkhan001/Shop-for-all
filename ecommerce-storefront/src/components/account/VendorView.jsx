        ...
        <div className="container mx-auto px-4 py-16 max-w-3xl">
            <div className="bg-gray-900 text-white p-10 rounded-[2rem] text-center relative overflow-hidden border border-gray-800 shadow-2xl">
                ...
                <div className="relative z-10">
                    <ShieldCheck size={48} className="mx-auto mb-6 text-[var(--sf-accent-muted)]" />
                    ...
                    <p className="text-gray-400 mb-10 max-w-md mx-auto">
                        ...
                        You are logged in as <span className="text-[var(--sf-accent-muted)] font-medium">{user.role}</span>.
                    </p>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a href={adminUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-white text-gray-900 px-8 py-3.5 rounded-xl font-bold hover:bg-[var(--sf-accent-bg)] transition-all transform hover:scale-105">
