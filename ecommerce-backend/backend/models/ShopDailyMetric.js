...
const shopDailyMetricSchema = new Schema({
    shop_id: {
...
shopDailyMetricSchema.index({ shop_id: 1, date: 1 }, { unique: true });
shopDailyMetricSchema.index({ date: -1 });

module.exports = mongoose.model('ShopDailyMetric', shopDailyMetricSchema);
